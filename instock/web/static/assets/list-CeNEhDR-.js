import{d as fe,m as me,c as C,p as F,b as z,q as pe,h as k,g as m,a as o,w as a,r as u,t as w,n as N,s as _e,o as c,e as d,y as D,C as ye,D as ve,F as ge,f as be,G as ke,H as we,I as xe,J as he,E as r,v as Ce,B as G,A as Se,_ as Te}from"./index-DAwTJcgT.js";import{c as Re,r as O,d as Y,e as j,f as Fe,h as De,m as Ae,i as Be,j as ze}from"./stock-DcV23CjG.js";const Ee={class:"algo-list"},Ke={key:0,class:"breadcrumb"},Ve={class:"folder-path"},Ne={class:"toolbar"},Ie={class:"name-cell"},Me={key:3,class:"name-text"},$e={key:0},Pe={key:0},Le={style:{display:"flex",gap:"12px"}},Ge=fe({__name:"list",setup(Oe){const q=Ce(),v=m([]),S=m([]),A=m(!1),p=m([]),g=m(0),E=m(""),T=m(null),B=m(""),R=m(!1),K=m(null),H={stock:"Code",multi_factor:"Factor",portfolio:"Portfolio",blank:"Code"},I={stock:`# 股票策略
