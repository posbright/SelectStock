...
export const mockKlineHistoryData = Array.from({ length: 60 }, (_, i) => {
  ...
  return {
    ...
    pre_close_price: +close.toFixed(2),
...
export const mockFundFlowData = [
  {
    ...
    code: '000001',
    name: '平安银行',
    main_net_inflow_price: 125680000,
    main_net_inflow_rate: 0.0856,
    super_large_net_inflow_price: 56780000,
    large_net_inflow_price: 68900000,
    medium_net_inflow_price: -23450000,
    small_net_inflow_price: -45670000,
    cdatetime: null
  },
  {
    date: '2026-01-20',
    code: '600519',
    name: '贵州茅台',
    main_net_inflow_price: 356780000,
    main_net_inflow_rate: 0.0923,
    super_large_net_inflow_price: 198760000,
    large_net_inflow_price: 158020000,
    medium_net_inflow_price: -67890000,
    small_net_inflow_price: -89650000,
