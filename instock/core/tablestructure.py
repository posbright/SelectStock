...
TABLE_CN_INDEX_SPOT = {'name': 'cn_index_spot', 'cn': '每日指数数据',
                       'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                   'code': {'type': VARCHAR(12, _COLLATE), 'cn': '代码', 'size': 80},
                                   'name': {'type': VARCHAR(20, _COLLATE), 'cn': '名称', 'size': 120},
                                   ...
                                   'volume': {'type': BIGINT, 'cn': '成交量', 'size': 90},
                                   'deal_amount': {'type': BIGINT, 'cn': '成交额', 'size': 100},
                                   'open_price': {'type': FLOAT, 'cn': '开盘价', 'size': 80},
                                   'high_price': {'type': FLOAT, 'cn': '最高价', 'size': 80},
                                   'low_price': {'type': FLOAT, 'cn': '最低价', 'size': 80},
                                   'pre_close_price': {'type': FLOAT, 'cn': '昨收', 'size': 80},
                                   'turnoverrate': {'type': FLOAT, 'cn': '换手率', 'size': 70},
                                   'total_market_cap': {'type': BIGINT, 'cn': '总市值', 'size': 120},
                                   'free_cap': {'type': BIGINT, 'cn': '流通市值', 'size': 120}}}
...
TABLE_CN_STOCK_lHB = {'name': 'cn_stock_lhb', 'cn': '股票龙虎榜',
                      'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                  ...
                                  'change_rate': {'type': FLOAT, 'cn': '涨跌幅', 'size': 70},
                                  'net_amount_buy': {'type': FLOAT, 'cn': '龙虎榜净买额(元)', 'size': 120},
                                  'sum_buy': {'type': FLOAT, 'cn': '龙虎榜买入额(元)', 'size': 120},
                                  'sum_sell': {'type': FLOAT, 'cn': '龙虎榜卖出额(元)', 'size': 120},
                                  'lhb_amount': {'type': FLOAT, 'cn': '龙虎榜成交额(元)', 'size': 120},
                                  'market_amount': {'type': FLOAT, 'cn': '市场总成交额(元)', 'size': 120},
...
TABLE_CN_STOCK_BLOCKTRADE = {'name': 'cn_stock_blocktrade', 'cn': '股票大宗交易',
                             'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0},
                                         ...
                                         'sum_volume': {'type': FLOAT, 'cn': '成交总量(万股)', 'size': 120},
                                         'sum_turnover': {'type': FLOAT, 'cn': '成交总额(万元)', 'size': 120},
...
TABLE_CN_STOCK_SELECTION = {'name': 'cn_stock_selection', 'cn': '综合选股',
                            'columns': {'date': {'type': DATE, 'cn': '日期', 'size': 0, 'map': 'MAX_TRADE_DATE'},
                                        ...
                                        'volume_ratio': {'type': FLOAT, 'cn': '量比', 'size': 70,
                                                         'map': 'VOLUME_RATIO'},
                                        'open': {'type': FLOAT, 'cn': '开盘价', 'size': 70, 'map': 'OPEN_PRICE'},
                                        ...
                                        'netinflow_5days': {'type': BIGINT, 'cn': '5日主力净流入', 'size': 110,
                                                            'map': 'NETINFLOW_5DAYS'},
                                        'nowinterst_ratio': {'type': FLOAT, 'cn': '当日增仓占比', 'size': 70,
